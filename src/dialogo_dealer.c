...
char dialogoDealer()
{
    ...
    if (escolha == 'B')
    {
        ...
        switch (drink)
        {
            case 'A': printf("Araujo: Cerveja gelada na faixa. Aproveita!"); break;
            case 'B': printf("Araujo: Refri docinho, estilo retro."); break;
            case 'C': printf("Araujo: Água... saúde em primeiro lugar."); break;
            case 'D': printf("Araujo: Beleza. Sem pressao."); break;
        }
